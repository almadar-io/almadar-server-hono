...
- **Codes:** new gaps use this repo's prefix `G-SERVER-HONO-`. Take the "Next code" below, then bump it in the same edit. Codes are never reused or renamed.
